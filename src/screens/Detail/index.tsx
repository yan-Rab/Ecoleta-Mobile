...
import { View, StyleSheet, Text, SafeAreaView, Linking,TouchableOpacity, Image } from 'react-native';
...
const Detail = () => {
  ...
  useEffect(() => {
    api.get(`pointsId/${routeParams.point_id}`).then(response => {
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${5585996922996}&text=Tenho interesse sobre coleta de resíduos `)
  }
  if(!data.points){
    return null;
  }
